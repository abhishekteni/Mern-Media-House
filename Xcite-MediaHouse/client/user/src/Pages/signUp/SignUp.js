  ...
  const submit = async () => {
    ...
    if (!passRegEx.test(userData.password)) {
      return toast.warning(
        "Password Must have Grater Than 8 Char. And have atleast one number, one uppercase and one lowercase letter"
      );
    }
      ...
      <Grid container style={{ height: "90vh" }}>
        <Grid item md={6}>
          <img
            ...
            src={
              "https://res.cloudinary.com/xciteeducation/image/upload/v1648322176/extra%20images/signUp.jpg"
            }
          />
        </Grid>
