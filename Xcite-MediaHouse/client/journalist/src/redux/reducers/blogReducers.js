...
export const blogcount = (state = {}, { type, payload }) => {
  switch (type) {
    case actionType.TOTAL_BLOG_COUNT:
      return { blog: payload };
    default:
      return state;
  }
};
export const usercount = (state = {}, { type, payload }) => {
  switch (type) {
    case actionType.TOTAL_USER_COUNT:
      return { blog: payload };
    default:
      return state;
  }
};
export const jouncount = (state = {}, { type, payload }) => {
  switch (type) {
    case actionType.TOTAL_JOUN_COUNT:
      return { blog: payload };
    default:
      return state;
  }
