...
export const gettotalBlogCount = (data) => {
  return {
    type: actionType.TOTAL_BLOG_COUNT,
    payload: data,
  };
};
export const gettotalUserCount = (data) => {
  return {
    type: actionType.TOTAL_USER_COUNT,
    payload: data,
  };
};
export const gettotalJounCount = (data) => {
  return {
    type: actionType.TOTAL_JOUN_COUNT,
    payload: data,
  };
};
